...
@section('content')
    ...
    <head>
        ...
        <link rel="preload" href="{{ asset('assets/fonts/fontawesome/fa-solid-900.woff2') }}" as="font" type="font/woff2"
        ...
        <script>
            ...
            function showPosition(position) {
                ...
                document.getElementById("map").innerHTML =
                    `<iframe src="${mapUrl}" width="100%" height="300" style="border:0;"></iframe>`;
            }
